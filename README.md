...
Download BonBon for Windows: [BonBon Browser 0.30.3 for Windows](https://github.com/BonBon-exchange/bonbon-web-browser/releases/download/v0.30.4/BonBon-Setup-0.30.4.exe)

Download BonBon portable for Windows: [BonBon Browser portable 0.30.3 for Windows](https://github.com/BonBon-exchange/bonbon-web-browser/releases/download/v0.30.4/BonBon-Browser---portable.exe)

Download BonBon for macOS arm64: [BonBon Browser 0.30.3 for macOS](https://github.com/BonBon-exchange/bonbon-web-browser/releases/download/v0.30.4/BonBon-0.30.4-arm64.dmg)

Download BonBon for macOS: [BonBon Browser 0.30.3 for macOS](https://github.com/BonBon-exchange/bonbon-web-browser/releases/download/v0.30.4/BonBon-0.30.4.dmg)

Download BonBon for Linux: [BonBon Browser 0.30.3 for Linux (AppImage)](https://github.com/BonBon-exchange/bonbon-web-browser/releases/download/v0.30.4/BonBon-0.30.4.AppImage)

...
export const Boards = ({ handleClose }: BoardsProps) => {
  ...
  return (
    <div className="bg-background-secondary text-text-primary fixed w-full h-full z-10 flex flex-col items-center overflow-y-auto">
      <CloseButton handleClose={handleClose} />
      <div className="flex flex-col w-[800px] flex-grow">
        <h2 className="text-2xl font-semibold mb-4">{t('Boards')}</h2>
        <input
          type="text"
          className="mb-7 rounded-sm h-8 text-sm px-5"
